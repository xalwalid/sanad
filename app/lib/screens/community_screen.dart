...
class CommunityScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final samples = code == 'ar'
        ? const [
            ['QN', 'هادئ', 'اليوم ١٢ · القنّب', 'تجاوزت عطلة صعبة جدًا. تمرين التنفّس ساعدني الساعة الثانية فجرًا. شكرًا لكم.'],
            ['SR', 'مستقر', 'اليوم ٩٠ · الكحول', '٩٠ يومًا اليوم. قبل ستة أشهر لم أظنّ أنّي سأتجاوز اليوم الثالث. الأمر يتحسّن.'],
            ['M7', 'جبل', 'اليوم ٤ · النيكوتين', 'هاجمتني الرغبة بعد الغداء. نشرت هنا بدل أن أستسلم. انتصار صغير لكنه لي.'],
          ]
        : const [
